    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={{ marginTop: 10 }}>
          ...
          <Text style={styles.infoText}><Text style={{fontWeight: 'bold'}}>Fecha de subasta:</Text> {subasta?.fecha ? `${subasta.fecha} a las ${subasta.hora?.slice(0,5) || '14:00'}` : '10/10/2026'}</Text>
